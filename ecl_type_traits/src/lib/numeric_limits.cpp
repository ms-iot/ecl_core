...
const numeric_limits<int64>::Precision numeric_limits<int64>::dummy_precision = 0.0;
const numeric_limits<uint64>::Precision numeric_limits<uint64>::dummy_precision = 0.0;

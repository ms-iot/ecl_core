...
/**
 * @brief Expands the std numeric_limits class for ecl:int64.
 *
 * @sa ecl::numeric_limits
 */
template <>
...
public:
	...
	static const int64 minimum = LONG_MIN;
	static const int64 maximum = LONG_MAX;
...
/**
 * @brief Expands the std numeric_limits class for ecl::uint64.
 *
 * @sa ecl::numeric_limits
 */
template <>
...
public:
	...
	static const uint16 bits = ECL_SIZE_OF_LONG*8;
	static const uint16 bytes = ECL_SIZE_OF_LONG;
	static const uint64 minimum = 0UL;
	static const uint64 maximum = ULONG_MAX;
